    ...
    g.get(l ? a.host + "explore/tags/" + a.tag : a.host + a.username, function (b) {
      ...
      if ("undefined" === typeof b) console.error("Instagram Feed: It looks like YOUR network has been temporary banned because of too many requests. See https://github.com/jsanahuja/jquery.instagramFeed/issues/25");
        ...
        a.styling &&
          ...
          (h = " style='border-radius:10em;width:15%;max-width:125px;min-width:50px;'"),
          (k = " style='font-size:1.2em;'"),
          (e = " style='font-size:1em;'"),
          (f = " style='margin:" + a.margin + "% " + a.margin + "%;width:" + (100 - 2 * a.margin * a.items_per_row) / a.items_per_row + "%;float:left;'"));
        var d = "";
        a.display_profile &&
          ((d = d + ("<div class='instagram_profile'" + c + ">") + ("<img class='instagram_profile_image' src='" + b.profile_pic_url + "' alt='" + (l ? b.name + " tag pic" : b.username + " profile pic") + "'" + h + " />")),
          (d = l
            ? d + ("<p class='instagram_tag'" + k + "><a href='https://www.instagram.com/explore/tags/" + a.tag + "' rel='noopener' target='_blank'>#" + a.tag + "</a></p>")
            : d + ("<p class='instagram_username'" + k + ">" + b.full_name + " (<a href='https://www.instagram.com/" + a.username + "' rel='noopener' target='_blank'>@" + a.username + "</a>)</p>")),
          !l && a.display_biography && (d += "<p class='instagram_biography'" + e + ">" + b.biography + "</p>"),
          (d += "</div>"));
        ...
        if (a.display_gallery)
          if ("undefined" !== typeof b.is_private && !0 === b.is_private) d += "<p class='instagram_private'><strong>O instagram de " + username + " é privado</strong></p>";
            ...
            for (c = 0; c < h; c++) {
              ...
              /*gambiarra pra trazer a img em 480px*/
              hd = e[c].node.thumbnail_resources[3].src;
              var t =
                "undefined" !== typeof e[c].node.edge_media_to_caption.edges[0] &&
                "undefined" !== typeof e[c].node.edge_media_to_caption.edges[0].node &&
                "undefined" !== typeof e[c].node.edge_media_to_caption.edges[0].node.text &&
                null !== e[c].node.edge_media_to_caption.edges[0].node.text
                  ? e[c].node.edge_media_to_caption.edges[0].node.text
                  : "undefined" !== typeof e[c].node.accessibility_caption && null !== e[c].node.accessibility_caption
                  ? e[c].node.accessibility_caption
                  : (l ? b.name : b.username) + " image " + c;
              d += "<a href='" + hd + "' class='instagram-" + p + "' rel='noopener' target='_blank'>";
              d += "<img src='" + q + "' alt=''" + f + " />";
              d += "</a>";
            }
            d += "</div>";
        ...
        if (a.display_igtv && "undefined" !== typeof b.edge_felix_video_timeline && ((b = b.edge_felix_video_timeline.edges), (h = b.length > a.items ? a.items : b.length), 0 < b.length)) {
          ...
          for (c = 0; c < h; c++)
            (d += "<a href='https://www.instagram.com/p/" + b[c].node.shortcode + "' rel='noopener' target='_blank'>"),
              (d += "<img src='" + b[c].node.thumbnail_src + "' alt='" + a.username + " instagram image " + c + "'" + f + " />"),
              (d += "</a>");
          d += "</div>";
        }
      ...
      console.error("Não foi possível carregar as fotos do Instagram. Erro:", a.status);
    });
    return !0;
  };
})(jQuery);
