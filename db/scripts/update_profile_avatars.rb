...
profiles_response = HTTParty.get("https://www.ubatubatem.com/profiles.json?limit=100&offset=860")
...
profiles.each do |p|
  ...
  puts "Atualizando avatar do perfil ID #{p['id']} no ubatubatem.com..."
  data = {profile: {avatar_url: avatar_url}}
  update_response = HTTParty.patch("https://www.ubatubatem.com/profiles/#{p['id']}/avatar", :body => data)
